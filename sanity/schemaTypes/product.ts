...
export const product = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      group: 'merchandising',
      description: 'Colour of the New / Best-Seller badge on the product page.',
      options: { list: [
    ...
    defineField({ name: 'badgeText_en', title: 'Badge Text (English)', type: 'string', group: 'merchandising', description: 'Override the badge label (e.g. "Limited Edition"). Leave blank for default.', validation: (R) => R.max(30) }),
    defineField({ name: 'badgeText_ar', title: 'نص الشارة (Arabic)', type: 'string', group: 'merchandising', validation: (R) => R.max(30) }),
    defineField({ name: 'hideThumbnails', title: 'Hide Image Thumbnails', type: 'boolean', group: 'merchandising', description: 'Hide the thumbnail strip on the product gallery.', initialValue: false }),
    defineField({ name: 'hideReviews', title: 'Hide Reviews Section', type: 'boolean', group: 'merchandising', description: 'Hide the customer reviews section on the product page.', initialValue: false }),
    defineField({
      name: 'new',
      title: 'New Arrival',
      type: 'boolean',
