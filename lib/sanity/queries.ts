...
export const getAboutPageQuery = `
  *[_type == "aboutPage"][0] {
    ...
    pillars,
    timeline,
    foundersHeadline_en, foundersHeadline_ar,
    foundersName, foundersRole_en, foundersRole_ar,
    foundersStory_en, foundersStory_ar,
    "foundersImageUrl": foundersImage.asset->url,
    behindBottleHeadline_en, behindBottleHeadline_ar,
    "behindBottleImages": behindBottleImages[]{
      "imageUrl": image.asset->url,
      "imageAlt": image.alt,
      caption_en, caption_ar
    },
    closingTitle_en, closingTitle_ar,
    closingStatement_en, closingStatement_ar,
